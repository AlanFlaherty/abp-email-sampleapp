...
@Injectable()
export class AccountValidationServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    validateAccount(input: ValidateAccountInput | null | undefined): Observable<ValidateAccountOutput> {
        let url_ = this.baseUrl + "/api/services/app/AccountValidationService/ValidateAccount";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processValidateAccount(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processValidateAccount(<any>response_);
                } catch (e) {
                    return <Observable<ValidateAccountOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ValidateAccountOutput>><any>_observableThrow(response_);
        }));
    }

    protected processValidateAccount(response: HttpResponseBase): Observable<ValidateAccountOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ValidateAccountOutput.fromJS(resultData200) : new ValidateAccountOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ValidateAccountOutput>(<any>null);
    }
}
...
export class ValidateAccountInput implements IValidateAccountInput {
    sourceComponentGuid: string | undefined;
    signalRConnectionID: string | undefined;
    username: string | undefined;
    password: string | undefined;
    iMapServerName: string | undefined;
    iMapServerPort: number | undefined;
    iMapSecurityType: string | undefined;
    smtpServerName: string | undefined;
    smtpServerPort: number | undefined;
    smtpSecurityType: string | undefined;

    constructor(data?: IValidateAccountInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.sourceComponentGuid = data["sourceComponentGuid"];
            this.signalRConnectionID = data["signalRConnectionID"];
            this.username = data["username"];
            this.password = data["password"];
            this.iMapServerName = data["iMapServerName"];
            this.iMapServerPort = data["iMapServerPort"];
            this.iMapSecurityType = data["iMapSecurityType"];
            this.smtpServerName = data["smtpServerName"];
            this.smtpServerPort = data["smtpServerPort"];
            this.smtpSecurityType = data["smtpSecurityType"];
        }
    }

    static fromJS(data: any): ValidateAccountInput {
        data = typeof data === 'object' ? data : {};
        let result = new ValidateAccountInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["sourceComponentGuid"] = this.sourceComponentGuid;
        data["signalRConnectionID"] = this.signalRConnectionID;
        data["username"] = this.username;
        data["password"] = this.password;
        data["iMapServerName"] = this.iMapServerName;
        data["iMapServerPort"] = this.iMapServerPort;
        data["iMapSecurityType"] = this.iMapSecurityType;
        data["smtpServerName"] = this.smtpServerName;
        data["smtpServerPort"] = this.smtpServerPort;
        data["smtpSecurityType"] = this.smtpSecurityType;
        return data; 
    }

    clone(): ValidateAccountInput {
        const json = this.toJSON();
        let result = new ValidateAccountInput();
        result.init(json);
        return result;
...
export interface IValidateAccountInput {
    sourceComponentGuid: string | undefined;
    signalRConnectionID: string | undefined;
    username: string | undefined;
    password: string | undefined;
...
export class ValidateAccountOutput implements IValidateAccountOutput {
    status: string | undefined;

    constructor(data?: IValidateAccountOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ValidateAccountOutput {
        data = typeof data === 'object' ? data : {};
        let result = new ValidateAccountOutput();
        result.init(data);
        return result;
    }
...
export interface IValidateAccountOutput {
    status: string | undefined;
}
